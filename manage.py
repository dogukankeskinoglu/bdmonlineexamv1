...
def insertQuestionDataBase(question:Question):
    ...
    db=Database()
    with db.get_cursor() as cursor:
        cursor.execute("INSERT INTO Soru(soru_sinav_id,soru_metni,soru_siklari,soru_dogru_cevap,soru_puani) VALUES (%d, %s,%s,%s,%d);",(question.question_exam_id,question.question_content,question.question_choices,question.correct_answer,question.question_point))
    db.commit()
